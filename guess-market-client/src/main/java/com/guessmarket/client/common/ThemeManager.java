...
public class ThemeManager {
    ...
    private static final String DARK_THEME = resource("/com/guessmarket/client/styles/dark.css");
    private static final String LIGHT_THEME = resource("/com/guessmarket/client/styles/light.css");
    private static final String SOLARIZED_THEME = resource("/com/guessmarket/client/styles/solarized.css");
    private static final String NORD_THEME = resource("/com/guessmarket/client/styles/nord.css");
    private static final String SEPIA_THEME = resource("/com/guessmarket/client/styles/sepia.css");
