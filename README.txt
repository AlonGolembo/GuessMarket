...
[x] Add verifications for overriding data (load an xml when one is already loaded,
    load saved state when there is an xml loaded, etc).
[x] Fix message printed to user when an xml file has errors in it (com/guessmarket/ui/console/menu/ConsoleApp.java:162)
...
[x] When closing an event, should I print how much money was paid out? How many winners
